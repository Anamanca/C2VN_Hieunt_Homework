...
async function main() {
    ...
    const scriptUtxo = (await blockchainProvider.fetchUTxOs('12b3f5b67184973faa95dced60bc23d397afd491c5f49c779cd9a1deb6e01df4'))[0];
    ...
    console.log(`tADA unlocked from the contract at Tx ID: ${txHash}`);
}
