...
Cấu hình như trong file tsconfig.json

## B5: open the package.json file add the following configurations

cấu hình như trong file package.json

# ------- Khởi tạo đã xong, giờ bạn có thể chạy code dự án ----------
# 
# cài compiler tsx thay cho ts-node
---bash
npm install tsx

# Chạy file code, để chạy từng file, lệnh được khai báo trong package.json
---bash
npm run start01
npm run start02
...
## Kết quả bài 2
-> Minted token: C2VN-HieuNT-v3
-> PolicyId ID: 3cac0003047ca9696399c9eb232a958d801fa0c71de7c1c8b3c22756
-> Recipient address: addr_test1qpuexzns2ze8g5csu30mnnk6gf2vx3kpwz2vcgvjsv7q3dr4mvw6eahqha5vj295mm0ugphljpesxaszfcff5hq9w63qrh0623
-> Transaction hash: a0a2f6f7a76594e22395d0d49ef78a759b5e9b49e09da82deb75247ebd123912

## Update thông tin cho user token
-> Update token: C2VN-HieuNT-v3
-> PolicyId ID: 3cac0003047ca9696399c9eb232a958d801fa0c71de7c1c8b3c22756
-> Recipient address: addr_test1qqvwp9g6dpup5p5c4mxvx7wm6el3s095sualft2rw5gz3pv0xanw9vg6emfj9e5yjduar6c4g05jk0gpwsvvf3kz2tfs6qevpe
-> Transaction hash: a510e5d36a4218e208ea929e7dd640f09a08bb151f6caf9a47ea410338b00464